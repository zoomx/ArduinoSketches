...
void drawGameScreen() {
  //  TV.clear_screen();
  //draw right paddle
  //max for wheelOnePosition is 1404 but joystick give a max value 665!
  //With 665 8 must be changed to 3.7868 ->4
  //thisvalue=((96 - PADDLE_HEIGHT)*MaxJoystickValue)/(120*120)
